...
public class SettlementEntity {
    ...
    public SettlementEntity(String cedent, ReceivableType receivableType, BigDecimal faceValue, Integer termInMonths,
        ...
        this.cedent = cedent; this.receivableType = receivableType; this.faceValue = faceValue; this.termInMonths = termInMonths;
